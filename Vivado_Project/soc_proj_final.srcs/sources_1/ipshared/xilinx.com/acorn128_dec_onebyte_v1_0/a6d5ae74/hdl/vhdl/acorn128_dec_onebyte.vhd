...
entity acorn128_dec_onebyte is
generic (
...
architecture behav of acorn128_dec_onebyte is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "acorn128_dec_onebyte,hls_ip_2014_4,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.220000,HLS_SYN_LAT=4855,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=457,HLS_SYN_LUT=669}";
    ...
    signal acorn128_dec_onebyte_AXILiteS_s_axi_U_ap_dummy_ce : STD_LOGIC;
    ...
    signal grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_start : STD_LOGIC;
    signal grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_done : STD_LOGIC;
    signal grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_idle : STD_LOGIC;
    signal grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_ready : STD_LOGIC;
    signal grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_state_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_state_ce0 : STD_LOGIC;
    signal grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_state_we0 : STD_LOGIC;
    signal grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_state_d0 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_state_q0 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ciphertextbit : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ca : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_cb : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_start_ap_start_reg : STD_LOGIC := '0';
    ...
    component acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component acorn128_dec_onebyte_AXILiteS_s_axi IS
    generic (
...
begin
    acorn128_dec_onebyte_AXILiteS_s_axi_U : component acorn128_dec_onebyte_AXILiteS_s_axi
    generic map (
    ...
    port map (
        ...
        ACLK => ap_clk,
        ARESET => ap_rst_n_inv,
        ACLK_EN => acorn128_dec_onebyte_AXILiteS_s_axi_U_ap_dummy_ce,
        ap_start => ap_start,
        interrupt => interrupt,
        ap_ready => ap_ready,
        ap_done => ap_done,
    ...
    grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73 : component acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_start,
        ap_done => grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_done,
        ap_idle => grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_idle,
        ap_ready => grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_ready,
        state_address0 => grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_state_address0,
        state_ce0 => grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_state_ce0,
        state_we0 => grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_state_we0,
        state_d0 => grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_state_d0,
        state_q0 => grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_state_q0,
        ciphertextbit => grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ciphertextbit,
        ca => grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ca,
        cb => grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_cb);
    ...
    -- grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_start_ap_start_reg assign process. --
    grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_start_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                elsif ((ap_const_logic_1 = grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_ready)) then 
                    grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_start_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not((ap_start = ap_const_logic_0)))) then
                ...
                tmp_5_reg_290 <= ciphertextbyte(1 downto 1);
                tmp_6_reg_295 <= cabyte(2 downto 2);
                tmp_7_reg_300 <= cbbyte(2 downto 2);
                tmp_8_reg_305 <= ciphertextbyte(2 downto 2);
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_done)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_st2_fsm_1 => 
                if (not((ap_const_logic_0 = grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_done))) then
    ...
    ap_done_assign_proc : process(grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_done, ap_sig_cseq_ST_st16_fsm_15)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st16_fsm_15) and not((ap_const_logic_0 = grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_done)))) then 
    ...
    ap_ready_assign_proc : process(grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_done, ap_sig_cseq_ST_st16_fsm_15)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st16_fsm_15) and not((ap_const_logic_0 = grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_done)))) then 
    ...
    grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_start <= grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ap_start_ap_start_reg;

    -- grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ca assign process. --
    grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ca_assign_proc : process(tmp_reg_265, tmp_3_reg_280, tmp_6_reg_295, tmp_9_reg_310, tmp_12_reg_325, tmp_15_reg_340, tmp_18_reg_355, tmp_22_reg_375, ap_sig_cseq_ST_st2_fsm_1, ap_sig_cseq_ST_st4_fsm_3, ap_sig_cseq_ST_st6_fsm_5, ap_sig_cseq_ST_st8_fsm_7, ap_sig_cseq_ST_st10_fsm_9, ap_sig_cseq_ST_st12_fsm_11, ap_sig_cseq_ST_st14_fsm_13, ap_sig_cseq_ST_st16_fsm_15)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st16_fsm_15)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ca <= tmp_22_reg_375;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st14_fsm_13)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ca <= tmp_18_reg_355;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st12_fsm_11)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ca <= tmp_15_reg_340;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st10_fsm_9)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ca <= tmp_12_reg_325;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st8_fsm_7)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ca <= tmp_9_reg_310;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st6_fsm_5)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ca <= tmp_6_reg_295;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ca <= tmp_3_reg_280;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ca <= tmp_reg_265;
        else 
    ...
    -- grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_cb assign process. --
    grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_cb_assign_proc : process(tmp_1_reg_270, tmp_4_reg_285, tmp_7_reg_300, tmp_10_reg_315, tmp_13_reg_330, tmp_16_reg_345, tmp_19_reg_360, tmp_23_reg_380, ap_sig_cseq_ST_st2_fsm_1, ap_sig_cseq_ST_st4_fsm_3, ap_sig_cseq_ST_st6_fsm_5, ap_sig_cseq_ST_st8_fsm_7, ap_sig_cseq_ST_st10_fsm_9, ap_sig_cseq_ST_st12_fsm_11, ap_sig_cseq_ST_st14_fsm_13, ap_sig_cseq_ST_st16_fsm_15)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st16_fsm_15)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_cb <= tmp_23_reg_380;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st14_fsm_13)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_cb <= tmp_19_reg_360;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st12_fsm_11)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_cb <= tmp_16_reg_345;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st10_fsm_9)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_cb <= tmp_13_reg_330;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st8_fsm_7)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_cb <= tmp_10_reg_315;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st6_fsm_5)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_cb <= tmp_7_reg_300;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_cb <= tmp_4_reg_285;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_cb <= tmp_1_reg_270;
        else 
    ...
    -- grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ciphertextbit assign process. --
    grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ciphertextbit_assign_proc : process(tmp_2_reg_275, tmp_5_reg_290, tmp_8_reg_305, tmp_11_reg_320, tmp_14_reg_335, tmp_17_reg_350, tmp_20_reg_365, tmp_21_reg_370, ap_sig_cseq_ST_st2_fsm_1, ap_sig_cseq_ST_st4_fsm_3, ap_sig_cseq_ST_st6_fsm_5, ap_sig_cseq_ST_st8_fsm_7, ap_sig_cseq_ST_st10_fsm_9, ap_sig_cseq_ST_st12_fsm_11, ap_sig_cseq_ST_st14_fsm_13, ap_sig_cseq_ST_st16_fsm_15)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st16_fsm_15)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ciphertextbit <= tmp_21_reg_370;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st14_fsm_13)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ciphertextbit <= tmp_20_reg_365;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st12_fsm_11)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ciphertextbit <= tmp_17_reg_350;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st10_fsm_9)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ciphertextbit <= tmp_14_reg_335;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st8_fsm_7)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ciphertextbit <= tmp_11_reg_320;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st6_fsm_5)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ciphertextbit <= tmp_8_reg_305;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ciphertextbit <= tmp_5_reg_290;
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1)) then 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ciphertextbit <= tmp_2_reg_275;
        else 
            grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_ciphertextbit <= "X";
        end if; 
    end process;

    grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_state_q0 <= state_q0;
    state_address0 <= grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_state_address0;

    -- state_ce0 assign process. --
    state_ce0_assign_proc : process(grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_state_ce0, ap_sig_cseq_ST_st2_fsm_1, ap_sig_cseq_ST_st4_fsm_3, ap_sig_cseq_ST_st6_fsm_5, ap_sig_cseq_ST_st8_fsm_7, ap_sig_cseq_ST_st10_fsm_9, ap_sig_cseq_ST_st12_fsm_11, ap_sig_cseq_ST_st14_fsm_13, ap_sig_cseq_ST_st16_fsm_15)
    begin
    ...
    state_we0_assign_proc : process(grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_state_we0, ap_sig_cseq_ST_st2_fsm_1, ap_sig_cseq_ST_st4_fsm_3, ap_sig_cseq_ST_st6_fsm_5, ap_sig_cseq_ST_st8_fsm_7, ap_sig_cseq_ST_st10_fsm_9, ap_sig_cseq_ST_st12_fsm_11, ap_sig_cseq_ST_st14_fsm_13, ap_sig_cseq_ST_st16_fsm_15)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) or (ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_3) or (ap_const_logic_1 = ap_sig_cseq_ST_st6_fsm_5) or (ap_const_logic_1 = ap_sig_cseq_ST_st8_fsm_7) or (ap_const_logic_1 = ap_sig_cseq_ST_st10_fsm_9) or (ap_const_logic_1 = ap_sig_cseq_ST_st12_fsm_11) or (ap_const_logic_1 = ap_sig_cseq_ST_st14_fsm_13) or (ap_const_logic_1 = ap_sig_cseq_ST_st16_fsm_15))) then 
            state_we0 <= grp_acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit_fu_73_state_we0;
        else 
    ...
    tmp_2_fu_92_p1 <= ciphertextbyte(1 - 1 downto 0);
