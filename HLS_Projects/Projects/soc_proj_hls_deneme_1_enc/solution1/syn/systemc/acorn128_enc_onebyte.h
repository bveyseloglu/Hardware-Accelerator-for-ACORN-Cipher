...
#ifndef _acorn128_enc_onebyte_HH_
#define _acorn128_enc_onebyte_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit.h"
#include "acorn128_enc_onebyte_AXILiteS_s_axi.h"

namespace ap_rtl {

template<unsigned int C_S_AXI_AXILITES_ADDR_WIDTH = 11,
         unsigned int C_S_AXI_AXILITES_DATA_WIDTH = 32>
struct acorn128_enc_onebyte : public sc_module {
    ...
    // Module declarations
    acorn128_enc_onebyte(sc_module_name name);
    SC_HAS_PROCESS(acorn128_enc_onebyte);
    ...
    acorn128_enc_onebyte_AXILiteS_s_axi<C_S_AXI_AXILITES_ADDR_WIDTH,C_S_AXI_AXILITES_DATA_WIDTH>* acorn128_enc_onebyte_AXILiteS_s_axi_U;
    ...
    sc_signal< sc_logic > acorn128_enc_onebyte_AXILiteS_s_axi_U_ap_dummy_ce;
    ...
    sc_signal< sc_logic > grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_ap_start;
    sc_signal< sc_logic > grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_ap_done;
    sc_signal< sc_logic > grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_ap_idle;
    sc_signal< sc_logic > grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_ap_ready;
    sc_signal< sc_lv<9> > grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_state_address0;
    sc_signal< sc_logic > grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_state_ce0;
    sc_signal< sc_logic > grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_state_we0;
    sc_signal< sc_lv<8> > grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_state_d0;
    sc_signal< sc_lv<8> > grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_state_q0;
    sc_signal< sc_lv<1> > grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_plaintextbit;
    sc_signal< sc_lv<1> > grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_ca;
    sc_signal< sc_lv<1> > grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_cb;
    sc_signal< sc_logic > grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_ap_start_ap_start_reg;
    ...
    void thread_acorn128_enc_onebyte_AXILiteS_s_axi_U_ap_dummy_ce();
    void thread_ap_done();
    void thread_ap_idle();
    ...
    void thread_grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_ap_start();
    void thread_grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_ca();
    void thread_grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_cb();
    void thread_grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_plaintextbit();
    void thread_grp_acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit_fu_73_state_q0();
