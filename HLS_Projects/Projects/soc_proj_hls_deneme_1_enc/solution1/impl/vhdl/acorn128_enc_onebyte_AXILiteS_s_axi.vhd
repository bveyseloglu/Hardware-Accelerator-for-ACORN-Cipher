...
entity acorn128_enc_onebyte_AXILiteS_s_axi is
    generic (
...
end entity acorn128_enc_onebyte_AXILiteS_s_axi;
...
architecture behave of acorn128_enc_onebyte_AXILiteS_s_axi is
    ...
    component acorn128_enc_onebyte_AXILiteS_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component acorn128_enc_onebyte_AXILiteS_s_axi_ram;
...
begin
    -- int_state
    int_state : acorn128_enc_onebyte_AXILiteS_s_axi_ram
        generic map (
         BYTES    => 4,
         DEPTH    => 74,
         AWIDTH   => log2(74))
...
entity acorn128_enc_onebyte_AXILiteS_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity acorn128_enc_onebyte_AXILiteS_s_axi_ram;

architecture behave of acorn128_enc_onebyte_AXILiteS_s_axi_ram is
