set moduleName acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit
...
set isOneStateSeq 0
set C_modelName acorn128_enc_onebyte_Encrypt_StateUpdate128_1bit
set C_modelType { void 0 }
set C_modelArgList { 
	{ state int 8 regular {array 293 { 2 } 1 1 }  }
	{ plaintextbit int 1 regular  }
	{ ca int 1 regular  }
	{ cb int 1 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "state", "interface" : "memory", "bitwidth" : 8} , 
 	{ "Name" : "plaintextbit", "interface" : "wire", "bitwidth" : 1} , 
...
set portList { 
	...
	{ plaintextbit sc_in sc_lv 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "plaintextbit", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "plaintextbit", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	plaintextbit { ap_none {  { plaintextbit in_data 0 1 } } }
