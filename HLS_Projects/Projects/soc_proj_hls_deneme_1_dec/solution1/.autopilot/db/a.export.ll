...
@str = internal constant [21 x i8] c"acorn128_dec_onebyte\00"
...
define i32 @acorn128_dec_onebyte([293 x i8]* %state, i8 zeroext %plaintextbyte, i8 zeroext %ciphertextbyte, i8 zeroext %ksbyte, i8 zeroext %cabyte, i8 zeroext %cbbyte) nounwind uwtable {
  ...
  %ciphertextbyte_read = call i8 @_ssdm_op_Read.s_axilite.i8(i8 %ciphertextbyte) nounwind
  ...
  %tmp_2 = trunc i8 %ciphertextbyte_read to i1
  call fastcc void @acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit([293 x i8]* %state, i1 %tmp_2, i1 %tmp, i1 %tmp_1) nounwind
  ...
  %tmp_5 = call i1 @_ssdm_op_BitSelect.i1.i8.i32(i8 %ciphertextbyte_read, i32 1)
  call fastcc void @acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit([293 x i8]* %state, i1 %tmp_5, i1 %tmp_3, i1 %tmp_4) nounwind
  ...
  %tmp_8 = call i1 @_ssdm_op_BitSelect.i1.i8.i32(i8 %ciphertextbyte_read, i32 2)
  call fastcc void @acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit([293 x i8]* %state, i1 %tmp_8, i1 %tmp_6, i1 %tmp_7) nounwind
  ...
  %tmp_11 = call i1 @_ssdm_op_BitSelect.i1.i8.i32(i8 %ciphertextbyte_read, i32 3)
  call fastcc void @acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit([293 x i8]* %state, i1 %tmp_11, i1 %tmp_9, i1 %tmp_10) nounwind
  ...
  %tmp_14 = call i1 @_ssdm_op_BitSelect.i1.i8.i32(i8 %ciphertextbyte_read, i32 4)
  call fastcc void @acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit([293 x i8]* %state, i1 %tmp_14, i1 %tmp_12, i1 %tmp_13) nounwind
  ...
  %tmp_17 = call i1 @_ssdm_op_BitSelect.i1.i8.i32(i8 %ciphertextbyte_read, i32 5)
  call fastcc void @acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit([293 x i8]* %state, i1 %tmp_17, i1 %tmp_15, i1 %tmp_16) nounwind
  ...
  %tmp_20 = call i1 @_ssdm_op_BitSelect.i1.i8.i32(i8 %ciphertextbyte_read, i32 6)
  call fastcc void @acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit([293 x i8]* %state, i1 %tmp_20, i1 %tmp_18, i1 %tmp_19) nounwind
  %tmp_21 = call i1 @_ssdm_op_BitSelect.i1.i8.i32(i8 %ciphertextbyte_read, i32 7)
  ...
  call fastcc void @acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit([293 x i8]* %state, i1 %tmp_21, i1 %tmp_22, i1 %tmp_23) nounwind
  ret i32 0
}
...
define internal fastcc void @acorn128_dec_onebyte_Decrypt_StateUpdate128_1bit([293 x i8]* nocapture %state, i1 %ciphertextbit, i1 %ca, i1 %cb) {
  ...
  %ciphertextbit_read = call i1 @_ssdm_op_Read.ap_auto.i1(i1 %ciphertextbit)
  %ciphertextbit_cast = zext i1 %ciphertextbit_read to i8
  ...
  %tmp_24 = trunc i8 %state_load_3 to i1
  ...
  %tmp_i_i_i = xor i8 %z_assign, %y_assign
  %tmp_1_i_i_i = and i8 %tmp_i_i_i, %state_load
  %tmp_2_i_i_i = and i8 %z_assign, %y_assign
  %tmp_i9_i_i = and i8 %state_load_7, %x_assign_1
  %tmp_4_i_i_i = xor i8 %x_assign_1, 1
  %tmp_5_i_i_i = and i8 %tmp_4_i_i_i, %state_load_9
  %tmp = xor i8 %tmp_1_i_i_i, %state_load_14
  %tmp9 = xor i8 %tmp, %tmp_2_i_i_i
  %tmp7 = xor i8 %tmp_i9_i_i, %tmp_5_i_i_i
  %tmp8 = xor i8 %tmp7, %tmp_3
  %tmp_i_i = xor i8 %tmp8, %tmp9
  %tmp_25 = trunc i8 %tmp_i_i to i1
  ...
  %tmp_1_i = and i1 %tmp_24, %ca_read
  %tmp_2_i = and i1 %tmp_25, %cb_read
  br label %1
...
; <label>:3                                       ; preds = %1
  %tmp10 = xor i8 %tmp_i_i, %ciphertextbit_cast
  %tmp11 = xor i1 %tmp_2_i, %tmp_1_i
  %tmp15_cast = zext i1 %tmp11 to i8
  %tmp12 = xor i8 %tmp15_cast, %tmp10
  %tmp13 = xor i8 %tmp_2_i_i, %tmp_1_i_i
  %tmp14 = xor i8 %state_load_12, 1
  %tmp15 = xor i8 %tmp14, %tmp_5
  %tmp16 = xor i8 %tmp15, %tmp13
  %tmp_4 = xor i8 %tmp16, %tmp12
