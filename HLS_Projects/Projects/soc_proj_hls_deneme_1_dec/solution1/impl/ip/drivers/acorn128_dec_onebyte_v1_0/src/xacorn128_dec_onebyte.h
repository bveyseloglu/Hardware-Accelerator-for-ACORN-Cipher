...
#ifndef XACORN128_DEC_ONEBYTE_H
#define XACORN128_DEC_ONEBYTE_H
...
} XAcorn128_dec_onebyte_Config;
#endif

typedef struct {
    u32 Axilites_BaseAddress;
    u32 IsReady;
} XAcorn128_dec_onebyte;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XAcorn128_dec_onebyte_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XAcorn128_dec_onebyte_ReadReg(BaseAddress, RegOffset) \
